...
var setSquare = function setSquare(board, index) {
  return [].concat(_toConsumableArray(board.slice(0, index)), [xIsNext(board) ? 'X' : 'O'], _toConsumableArray(board.slice(index + 1, board.length)));
};
